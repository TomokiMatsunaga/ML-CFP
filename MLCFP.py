...
def parallel_evaluation(wav_file, txt_path, ref_type, dataset, instrument_wise, instlist, length=length, window=window,
    ...
    fs, data = wavfile.read(wav_file)
    t, pr0 = peaks_decision(fs, data, length, window, W, H, fftnum, p0, qc, qp, peakth, peakd, alpha, fu1,
...
if __name__ == '__main__':
    ...
    t, pr0 = peaks_decision(fs, data, length)
